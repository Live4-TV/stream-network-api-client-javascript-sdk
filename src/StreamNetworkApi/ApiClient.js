...
/**
* @module StreamNetworkApi/ApiClient
* @version 1.0.0
*/
...
* @alias module:StreamNetworkApi/ApiClient
* @class
*/
class ApiClient {
    /**
    ...
    * @param {module:StreamNetworkApi/ApiClient.CollectionFormatEnum} collectionFormat The array element separator strategy.
    ...
    * @callback module:StreamNetworkApi/ApiClient~callApiCallback
    ...
    * @param {module:StreamNetworkApi/ApiClient~callApiCallback} callback The callback function.
...
* @type {module:StreamNetworkApi/ApiClient}
*/
