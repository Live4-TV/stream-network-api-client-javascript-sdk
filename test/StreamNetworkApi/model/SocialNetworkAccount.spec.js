...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Live4TvStreamTargets.SocialNetworkAccount();
  });
  ...
  describe('SocialNetworkAccount', function() {
    it('should create an instance of SocialNetworkAccount', function() {
      // uncomment below and update the code to test SocialNetworkAccount
      //var instance = new Live4TvStreamTargets.SocialNetworkAccount();
      //expect(instance).to.be.a(Live4TvStreamTargets.SocialNetworkAccount);
    });
