...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Live4TvStreamTargets.ToggleCommentResponse();
  });
  ...
  describe('ToggleCommentResponse', function() {
    it('should create an instance of ToggleCommentResponse', function() {
      // uncomment below and update the code to test ToggleCommentResponse
      //var instance = new Live4TvStreamTargets.ToggleCommentResponse();
      //expect(instance).to.be.a(Live4TvStreamTargets.ToggleCommentResponse);
    });
