...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Live4TvStreamTargets.StopListeningToCommentsResponse();
  });
  ...
  describe('StopListeningToCommentsResponse', function() {
    it('should create an instance of StopListeningToCommentsResponse', function() {
      // uncomment below and update the code to test StopListeningToCommentsResponse
      //var instance = new Live4TvStreamTargets.StopListeningToCommentsResponse();
      //expect(instance).to.be.a(Live4TvStreamTargets.StopListeningToCommentsResponse);
    });
