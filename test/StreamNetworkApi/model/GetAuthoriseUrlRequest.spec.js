...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Live4TvStreamTargets.GetAuthoriseUrlRequest();
  });
  ...
  describe('GetAuthoriseUrlRequest', function() {
    it('should create an instance of GetAuthoriseUrlRequest', function() {
      // uncomment below and update the code to test GetAuthoriseUrlRequest
      //var instance = new Live4TvStreamTargets.GetAuthoriseUrlRequest();
      //expect(instance).to.be.a(Live4TvStreamTargets.GetAuthoriseUrlRequest);
    });

    it('should have the property userExternalId (base name: "userExternalId")', function() {
      // uncomment below and update the code to test the property userExternalId
      //var instance = new Live4TvStreamTargets.GetAuthoriseUrlRequest();
