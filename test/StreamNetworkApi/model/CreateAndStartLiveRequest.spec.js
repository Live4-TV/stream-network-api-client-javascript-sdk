...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Live4TvStreamTargets.CreateAndStartLiveRequest();
  });
  ...
  describe('CreateAndStartLiveRequest', function() {
    it('should create an instance of CreateAndStartLiveRequest', function() {
      // uncomment below and update the code to test CreateAndStartLiveRequest
      //var instance = new Live4TvStreamTargets.CreateAndStartLiveRequest();
      //expect(instance).to.be.a(Live4TvStreamTargets.CreateAndStartLiveRequest);
    });
