...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Live4TvStreamTargets.StopLiveRequest();
  });
  ...
  describe('StopLiveRequest', function() {
    it('should create an instance of StopLiveRequest', function() {
      // uncomment below and update the code to test StopLiveRequest
      //var instance = new Live4TvStreamTargets.StopLiveRequest();
      //expect(instance).to.be.a(Live4TvStreamTargets.StopLiveRequest);
    });
    ...
    it('should have the property saveLive (base name: "saveLive")', function() {
      // uncomment below and update the code to test the property saveLive
      //var instance = new Live4TvStreamTargets.StopLiveRequest();
      //expect(instance).to.be();
    });
