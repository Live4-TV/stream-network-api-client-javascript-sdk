...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Live4TvStreamTargets.CommentsResponse();
  });
  ...
  describe('CommentsResponse', function() {
    it('should create an instance of CommentsResponse', function() {
      // uncomment below and update the code to test CommentsResponse
      //var instance = new Live4TvStreamTargets.CommentsResponse();
      //expect(instance).to.be.a(Live4TvStreamTargets.CommentsResponse);
    });
