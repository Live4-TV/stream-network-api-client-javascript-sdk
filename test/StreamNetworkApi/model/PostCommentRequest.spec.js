...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Live4TvStreamTargets.PostCommentRequest();
  });
  ...
  describe('PostCommentRequest', function() {
    it('should create an instance of PostCommentRequest', function() {
      // uncomment below and update the code to test PostCommentRequest
      //var instance = new Live4TvStreamTargets.PostCommentRequest();
      //expect(instance).to.be.a(Live4TvStreamTargets.PostCommentRequest);
    });
