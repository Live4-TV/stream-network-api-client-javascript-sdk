...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Live4TvStreamTargets.CreateAndStartLiveResponse();
  });
  ...
  describe('CreateAndStartLiveResponse', function() {
    it('should create an instance of CreateAndStartLiveResponse', function() {
      // uncomment below and update the code to test CreateAndStartLiveResponse
      //var instance = new Live4TvStreamTargets.CreateAndStartLiveResponse();
      //expect(instance).to.be.a(Live4TvStreamTargets.CreateAndStartLiveResponse);
    });
