...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Live4TvStreamTargets.CreateAndStartLiveAccountDetailsResponse();
  });
  ...
  describe('CreateAndStartLiveAccountDetailsResponse', function() {
    it('should create an instance of CreateAndStartLiveAccountDetailsResponse', function() {
      // uncomment below and update the code to test CreateAndStartLiveAccountDetailsResponse
      //var instance = new Live4TvStreamTargets.CreateAndStartLiveAccountDetailsResponse();
      //expect(instance).to.be.a(Live4TvStreamTargets.CreateAndStartLiveAccountDetailsResponse);
    });
