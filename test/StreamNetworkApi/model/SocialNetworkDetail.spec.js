...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Live4TvStreamTargets.SocialNetworkDetail();
  });
  ...
  describe('SocialNetworkDetail', function() {
    it('should create an instance of SocialNetworkDetail', function() {
      // uncomment below and update the code to test SocialNetworkDetail
      //var instance = new Live4TvStreamTargets.SocialNetworkDetail();
      //expect(instance).to.be.a(Live4TvStreamTargets.SocialNetworkDetail);
    });
