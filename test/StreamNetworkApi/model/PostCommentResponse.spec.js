...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Live4TvStreamTargets.PostCommentResponse();
  });
  ...
  describe('PostCommentResponse', function() {
    it('should create an instance of PostCommentResponse', function() {
      // uncomment below and update the code to test PostCommentResponse
      //var instance = new Live4TvStreamTargets.PostCommentResponse();
      //expect(instance).to.be.a(Live4TvStreamTargets.PostCommentResponse);
    });
