...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Live4TvStreamTargets.SocialNetworkResponse();
  });
  ...
  describe('SocialNetworkResponse', function() {
    it('should create an instance of SocialNetworkResponse', function() {
      // uncomment below and update the code to test SocialNetworkResponse
      //var instance = new Live4TvStreamTargets.SocialNetworkResponse();
      //expect(instance).to.be.a(Live4TvStreamTargets.SocialNetworkResponse);
    });
    ...
    it('should have the property socialNetworks (base name: "social_networks")', function() {
