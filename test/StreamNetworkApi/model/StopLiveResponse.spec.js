...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Live4TvStreamTargets.StopLiveResponse();
  });
  ...
  describe('StopLiveResponse', function() {
    it('should create an instance of StopLiveResponse', function() {
      // uncomment below and update the code to test StopLiveResponse
      //var instance = new Live4TvStreamTargets.StopLiveResponse();
      //expect(instance).to.be.a(Live4TvStreamTargets.StopLiveResponse);
    });
