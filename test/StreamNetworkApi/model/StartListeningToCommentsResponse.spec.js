...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Live4TvStreamTargets.StartListeningToCommentsResponse();
  });
  ...
  describe('StartListeningToCommentsResponse', function() {
    it('should create an instance of StartListeningToCommentsResponse', function() {
      // uncomment below and update the code to test StartListeningToCommentsResponse
      //var instance = new Live4TvStreamTargets.StartListeningToCommentsResponse();
      //expect(instance).to.be.a(Live4TvStreamTargets.StartListeningToCommentsResponse);
    });
