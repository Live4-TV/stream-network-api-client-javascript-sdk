...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Live4TvStreamTargets.StopLiveDetailsResponse();
  });
  ...
  describe('StopLiveDetailsResponse', function() {
    it('should create an instance of StopLiveDetailsResponse', function() {
      // uncomment below and update the code to test StopLiveDetailsResponse
      //var instance = new Live4TvStreamTargets.StopLiveDetailsResponse();
      //expect(instance).to.be.a(Live4TvStreamTargets.StopLiveDetailsResponse);
    });
