...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Live4TvStreamTargets.StartListeningToCommentsRequest();
  });
  ...
  describe('StartListeningToCommentsRequest', function() {
    it('should create an instance of StartListeningToCommentsRequest', function() {
      // uncomment below and update the code to test StartListeningToCommentsRequest
      //var instance = new Live4TvStreamTargets.StartListeningToCommentsRequest();
      //expect(instance).to.be.a(Live4TvStreamTargets.StartListeningToCommentsRequest);
    });
