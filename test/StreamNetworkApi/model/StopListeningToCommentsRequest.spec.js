...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Live4TvStreamTargets.StopListeningToCommentsRequest();
  });
  ...
  describe('StopListeningToCommentsRequest', function() {
    it('should create an instance of StopListeningToCommentsRequest', function() {
      // uncomment below and update the code to test StopListeningToCommentsRequest
      //var instance = new Live4TvStreamTargets.StopListeningToCommentsRequest();
      //expect(instance).to.be.a(Live4TvStreamTargets.StopListeningToCommentsRequest);
    });
