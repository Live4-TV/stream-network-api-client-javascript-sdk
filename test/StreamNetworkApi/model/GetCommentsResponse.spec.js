...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Live4TvStreamTargets.GetCommentsResponse();
  });
  ...
  describe('GetCommentsResponse', function() {
    it('should create an instance of GetCommentsResponse', function() {
      // uncomment below and update the code to test GetCommentsResponse
      //var instance = new Live4TvStreamTargets.GetCommentsResponse();
      //expect(instance).to.be.a(Live4TvStreamTargets.GetCommentsResponse);
    });
    ...
    it('should have the property lastCommentTimestamp (base name: "lastCommentTimestamp")', function() {
      // uncomment below and update the code to test the property lastCommentTimestamp
      //var instance = new Live4TvStreamTargets.GetCommentsResponse();
      //expect(instance).to.be();
    });
