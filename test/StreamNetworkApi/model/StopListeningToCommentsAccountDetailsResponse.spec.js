...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Live4TvStreamTargets.StopListeningToCommentsAccountDetailsResponse();
  });
  ...
  describe('StopListeningToCommentsAccountDetailsResponse', function() {
    it('should create an instance of StopListeningToCommentsAccountDetailsResponse', function() {
      // uncomment below and update the code to test StopListeningToCommentsAccountDetailsResponse
      //var instance = new Live4TvStreamTargets.StopListeningToCommentsAccountDetailsResponse();
      //expect(instance).to.be.a(Live4TvStreamTargets.StopListeningToCommentsAccountDetailsResponse);
    });
