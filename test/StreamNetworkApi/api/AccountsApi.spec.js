...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Live4TvStreamTargets.AccountsApi();
  });
  ...
  describe('AccountsApi', function() {
    describe('socialNetworkAccountControllerGetAccount', function() {
      it('should call socialNetworkAccountControllerGetAccount successfully', function(done) {
        //uncomment below and update the code to test socialNetworkAccountControllerGetAccount
        //instance.socialNetworkAccountControllerGetAccount(function(error) {
    ...
    describe('socialNetworkAccountControllerGetAuthoriseUrl', function() {
      it('should call socialNetworkAccountControllerGetAuthoriseUrl successfully', function(done) {
        //uncomment below and update the code to test socialNetworkAccountControllerGetAuthoriseUrl
        //instance.socialNetworkAccountControllerGetAuthoriseUrl(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
