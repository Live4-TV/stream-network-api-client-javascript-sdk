...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Live4TvStreamTargets.LiveStreamsApi();
  });
  ...
  describe('LiveStreamsApi', function() {
    describe('liveStreamsControllerCreateAndStartLive', function() {
      it('should call liveStreamsControllerCreateAndStartLive successfully', function(done) {
        //uncomment below and update the code to test liveStreamsControllerCreateAndStartLive
        //instance.liveStreamsControllerCreateAndStartLive(function(error) {
    ...
    describe('liveStreamsControllerStopLive', function() {
      it('should call liveStreamsControllerStopLive successfully', function(done) {
        //uncomment below and update the code to test liveStreamsControllerStopLive
        //instance.liveStreamsControllerStopLive(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
